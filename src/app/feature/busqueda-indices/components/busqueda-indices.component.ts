...
@Component({
  ...
  templateUrl: './busqueda-indices.component.html',
  styleUrls: ['./busqueda-indices.component.css']
})
export class BusquedaIndicesComponent {
  /**
  * bloques
  * indice_en_bloques
  * registros_bloques
  ...
  */
  ...
  public registros:ModeloUsuario[]=[];
  ...
  public bloque:ModeloUsuario[]=[]
  public bloques:ModeloUsuario[][] = [[]];
  ...
  public crearRegistro(id: number,info: string) {
    ...
    let registro:ModeloUsuario = {id: id,info: info};
  ...
  **/
  ...
  getIndicesPrimariosDensos(){
    ...
    for(let i=0; i<this.bloques_totales; i++){
      let bloque_actual:ModeloUsuario[]=[];
